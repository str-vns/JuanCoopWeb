...
const FarmRegistration = () => {
  ...
  const [viewState, setViewState] = useState({ longitude: 120.9842, latitude: 14.5995, zoom: 13,});
  const [markerPosition, setMarkerPosition] = useState({ longitude: 120.9842, latitude: 14.5995, });
  ...
  const [orgStructure, setOrgStructure] = useState([]);
   ...
   const handleSave =(e) => {
    e.preventDefault();
    if(!myAddress || !barangay || !city || !postalCode || !latitude || !longitude || !coopName || imagesPreview.length === 0 || !businessPermit || !corCDA || !orgStructure) {
    ...
    <>
      ...
      <div className="min-h-screen bg-gray-50 mt-14">
        <div className="max-w-4xl mx-auto bg-white p-6 rounded-lg shadow-lg">
          <h2 className="text-2xl font-semibold text-center text-gray-800 mb-6">Farm Registration</h2>
          ...
          <form onSubmit={handleSave}>
            ...
            <div className="mt-6">
            <label className="block text-gray-700 mb-2">Upload Business Permit</label>
            <input
  type="file"
   name="businessPermit"
...
/>
          ...
          <div className="mt-6">
            <label className="block text-gray-700 mb-2">Upload COR File</label>
            <input
  type="file"
   name="corCDA"
...
/>
          ...
          <div className="mt-6">
            <label className="block text-gray-700 mb-2">Organization Structure File</label>
            <input
  type="file"
   name="orgStructure"
...
/>
            ...
            <div className="mt-6 text-center">
              <button
                type="submit"
                className="w-full px-4 py-2 text-white bg-yellow rounded-md hover:bg-yellow-600 focus:outline-none"
              >
                Register
              </button>
            </div>
