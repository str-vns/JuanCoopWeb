...
function addressUpdate() {
  ...
  return (
      <div>
         ...
         <div className="imageR-section p-10 text-white" style={{ height: "500px", width: "40%", display: "flex", flexDirection: "column"}}>
      <Map
         ...
         <div>
             ...
             <button onClick={handleSearchClick} className="search-btn">
               ...
               <div className="register-signup-card">
                 <h1 className="register-form-title">Add Address</h1>
                   ...
                   <div className="register-form-row">
                     <div className="register-form-group">
                       ...
                       <input
                         ...
                         className="register-form-input text-black"
                         required
                         disabled
                       />
                     </div>
