  ...
  return (
    <Fragment>
      ...
      <div className="flex mt-[75px] bg-white items-center w-full h-full">
        <div className="lg:grid flex flex-grow overflow-y-scroll justify-center items-center">
          <div className="flex flex-col items-center bg-white">
            <h1 className="my-1 font-bold text-lg text-black">All Addresses</h1>
            <div className="mb-5">
              <button
                className="inline-block rounded-lg bg-black ml-[900px] px-5 py-3 text-sm font-medium text-white hover:bg-white hover:text-black"
                style={{
            ...
            <div className="w-[1080px] overflow-x-auto">
              {loading ? (
                ...
                <MDBDataTable
                  ...
                  entries={10} // Set the entries count dynamically based on the available data
                  noBottomColumns
                  activePage={1}
                />
              )}
